...
## My Contribution
My primary contributions to this project included conducting background research to inform the blade design for our project. I took the lead in developing the objectives, constraints, hypotheses, and experimental testing protocol for our specific design, ensuring consistent procedures for data collection and safe, repeatable operation in the wind tunnel. I was also actively involved in executing the blade tests and refining the methodology based on observed performance. Following testing, I contributed to the development of post-processing methods used to analyze the experimental data. These efforts helped connect the design assumptions to measured outcomes and strengthened the overall project.
